...
- **Granular category control:** Toggle updates independently for Add-ons, HACS integrations, device firmware (anything with `device_class: firmware`), and HA Core/OS.
